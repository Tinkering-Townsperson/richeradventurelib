...
try:
	...
	try:
		from backports.shutil_get_terminal_size import get_terminal_size  # type: ignore
	except ImportError:
...
#: Rich console setup
#:
#: This will be used for all output, and can be customized by the user if they want to
console = Console(
	highlight=False,
	force_terminal=True,
...
class Pattern:
	...
	def match(self, input_words):  # noqa
...
def no_command_matches(command):
	...
	console.print("I don't understand '%s'." % command)
...
def help():
	...
	console.print('Here is a list of the commands you can give:')
